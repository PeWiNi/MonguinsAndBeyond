...
if ($_POST)
{
    ...
    {
        //if it indeed theres an field called action. check if its value its image upload
            ...
            if ($_FILES['file']['error'] === UPLOAD_ERR_OK)
            {
                ...
                if ($_FILES['file']['name'] !== "")
                {
                    ...
                    if ($_FILES['file']['type'] === 'image/png')
                    {
                        ...
                        $uploadfile =  '/home/username/public_html/Images/' . $_FILES['file']['name']; // CHANGE THIS TO WHEREVER WE WANT TO PUT STUFF
